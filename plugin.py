...
class BasePlugin:
    ...
    def onStart(self):
        ...
        #icon_unifi_home = Images[UnifiHome].ID
        #Domoticz.Log(strName+"ID = "+str(icon_unifi_home))
        #for item in Images:
        ...
        #icon_unifi_override = Images["UnifiOverride"].ID
        #Domoticz.Log(strName+"ID = "+str(icon_unifi_override))
        #for item in Images:
        ...
        #Domoticz.Log(strName+"ID = "+str(icon_unifi_unit))
        #for item in Images:
        ...
        if (self.UNIFI_OVERRIDE_UNIT not in Devices):
            Options = {"LevelActions": "||||",
                       ...
                       "SelectorStyle": "0"}
            Domoticz.Device(Name="OverRide", Unit=self.UNIFI_OVERRIDE_UNIT, TypeName="Selector Switch", Switchtype=18, Options=Options).Create()
